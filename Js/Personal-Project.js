function emptyFormAlert() {
  ...
  if(projectName == "") {
      return alert("Input Name wajib di isi..!");
  } else if(startDate == "") {
      return alert("Input start date wajib di isi..!");
  } else if(finishDate == "") {
      return alert("Input Finist Date wajib di isi..!");
  } else if(description == "") {
      return alert("Input Descriptions wajib di isi..!");
  } else if(multiInput.length === 0) {
      return alert("Technologish Wajib di isi..!");
  } else if(image == "") {
      return alert("Imagge wajib di isi..!");
  };
};
...
function postProject(event) {
  ...
  if(multiInput.length === 0) {
      return alert("Input wajib di isi..!");
  };
  ...
  if (sDvalidation > fDvalidation) {
      return alert("Waktu Tidak Ditemukan ?");
  };
